<script>
    ...
    const facebook = $derived(schoolProfile?.facebook_url || "#");
    const instagram = $derived(schoolProfile?.instagram_url || "#");
        ...
        <div class="flex justify-between h-20">
            ...
            >
                ...
                <div class="relative h-full flex items-center">
                    ...
                    {#if aboutDropdownOpen}
                        <div
                            ...
                            tabindex="-1"
                            class="absolute left-1/2 -translate-x-1/2 top-full mt-0 w-56 rounded-xl bg-slate-800 border border-slate-700 shadow-xl z-9999"
                        >
                ...
                <a
                    ...
                    class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-semibold transition-all duration-200 h-full {currentRoute.startsWith(
                        'Programs',
                    )
                        ? 'border-amber-400 text-amber-400'
                        : 'border-transparent text-slate-300 hover:text-white hover:border-slate-300'}"
    ...
    {#if mobileMenuOpen}
        ...
        >
            <div class="px-4 pt-2 pb-6 space-y-1">
                ...
                <a
                    href="/program-pendidikan"
                    class="flex items-center px-3 py-3 rounded-lg text-base font-medium {currentRoute.startsWith(
                        'Programs',
                    )
                        ? 'bg-white/10 text-amber-400'
                        : 'text-slate-300'}"
