            ...
            <div class="text-center">
                <nav class="mb-4 flex justify-center" aria-label="Breadcrumb">
                    <ol class="flex items-center space-x-2 text-indigo-200">
                        <li>
                            <a href="{{ route('public.programs.index') }}" class="hover:text-white">
                                Program Pendidikan
                            </a>
                        </li>
                        <li>
                ...
                <h1 class="mb-4 text-4xl font-bold md:text-5xl">{{ $program->name }}</h1>
                <p class="text-xl text-indigo-100">{{ $program->level }}</p>
            </div>
        </div>
    </div>
            ...
            <div class="grid grid-cols-1 gap-12 lg:grid-cols-3">
                ...
                <div class="lg:col-span-2">
                    ...
                    @if ($program->curriculum_overview)
                        <div class="mb-8">
                            <h2 class="mb-4 text-2xl font-bold text-gray-900">Kurikulum</h2>
                    ...
                    @if ($program->requirements)
                        <div class="mb-8">
                            <h2 class="mb-4 text-2xl font-bold text-gray-900">Persyaratan</h2>
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-8 space-y-6">
                        ...
                        <div class="rounded-lg bg-white p-6 shadow-lg">
                            <h3 class="mb-4 text-lg font-bold text-gray-900">Informasi Program</h3>
                            <div class="space-y-3">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-900">Tingkat</p>
                                        <p class="text-sm text-gray-600">{{ $program->level }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        @if ($schoolProfile)
                            <div class="rounded-lg bg-indigo-50 p-6">
                                <h3 class="mb-4 text-lg font-bold text-indigo-900">Informasi Pendaftaran</h3>
                                <div class="space-y-3">
                                    @if ($schoolProfile->phone)
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-indigo-900">Telepon</p>
                                                <a href="tel:{{ $schoolProfile->phone }}" class="text-sm text-indigo-700 hover:text-indigo-800">
                                                    {{ $schoolProfile->phone }}
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    @if ($schoolProfile->email)
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-indigo-900">Email</p>
                                                <a href="mailto:{{ $schoolProfile->email }}" class="text-sm text-indigo-700 hover:text-indigo-800">
                                                    {{ $schoolProfile->email }}
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    @if ($schoolProfile->address)
                                        <div class="flex items-start gap-3">
                                            <svg class="mt-1 h-5 w-5 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                                            </svg>
                                            <div>
                                                <p class="text-sm font-medium text-indigo-900">Alamat</p>
                                                <p class="text-sm text-indigo-700">{{ $schoolProfile->address }}</p>
                                            </div>
                                        </div>
                                    @endif
                                </div>
