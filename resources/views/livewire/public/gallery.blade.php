            ...
            <div class="mb-8">
                <div class="flex flex-wrap gap-2 justify-center">
                    <button 
                        ...
                        class="px-6 py-3 rounded-full text-sm font-semibold transition-all duration-200 {{ $selectedCategory === '' ? 'bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg' : 'bg-white text-gray-700 hover:bg-green-50 hover:text-green-700 shadow-md' }}"
                    >
                        Semua
                    </button>
                    @foreach($categories as $category)
                        <button 
                            ...
                            class="px-6 py-3 rounded-full text-sm font-semibold transition-all duration-200 {{ $selectedCategory === $category ? 'bg-gradient-to-r from-green-600 to-emerald-600 text-white shadow-lg' : 'bg-white text-gray-700 hover:bg-green-50 hover:text-green-700 shadow-md' }}"
                        >
                            {{ $category }}
                        </button>
                    @endforeach
                ...
                @foreach($photos as $photo)
                    <div class="group relative overflow-hidden rounded-lg bg-gray-200 aspect-square">
                        ...
                        <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition duration-300 flex items-center justify-center">
                            <div class="text-white opacity-0 group-hover:opacity-100 transition duration-300 text-center p-4">
