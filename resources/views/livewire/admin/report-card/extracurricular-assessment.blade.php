                        ...
                        <tr wire:key="{{ $student->id }}">
                            ...
                            <td class="px-4 py-3">
                                <flux:select wire:model="assessments_data.{{ $student->id }}.level">
                                    <flux:select.option value="Sangat Baik">Sangat Baik</flux:select.option>
                                    <flux:select.option value="Baik">Baik</flux:select.option>
                                    <flux:select.option value="Cukup">Cukup</flux:select.option>
                                    <flux:select.option value="Perlu Ditingkatkan">Perlu Ditingkatkan</flux:select.option>
                                </flux:select>
                            </td>
                            <td class="px-4 py-3">
                                <flux:input 
