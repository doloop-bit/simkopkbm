        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="sm:col-span-2 lg:col-span-2">
                <div class="flex items-center space-x-3 mb-6">
                    <div class="w-12 h-12 bg-gradient-to-br from-amber-400 to-yellow-600 rounded-xl flex items-center justify-center shadow-lg">
                        <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                        </svg>
                    </div>
                    <div>
                        <h3 class="text-xl font-bold font-heading text-white tracking-tight">{{ config('app.name') }}</h3>
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="#" class="w-10 h-10 bg-slate-800 hover:bg-amber-500 hover:text-white text-slate-400 rounded-lg flex items-center justify-center transition-all duration-200 shadow-lg hover:shadow-amber-500/20 hover:-translate-y-1">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start">
                        <div class="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center text-amber-500 mt-0.5 mr-3 flex-shrink-0">
                        ...
                        <div>
                            ...
                            <p class="text-white text-sm font-medium">info@pkbm.test</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center text-amber-500 mt-0.5 mr-3 flex-shrink-0">
                        ...
                        <div>
                            ...
                            <p class="text-white text-sm font-medium">(021) 1234-5678</p>
                        </div>
                    </li>
                    <li class="flex items-start">
                        <div class="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center text-amber-500 mt-0.5 mr-3 flex-shrink-0">
