        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="sm:col-span-2 lg:col-span-2">
                    ...
                    <p class="text-green-100 text-sm leading-relaxed max-w-md mb-6">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('public.about') }}" class="text-green-200 hover:text-white transition-colors duration-200 flex items-center group text-sm">
                            <svg class="w-4 h-4 mr-2 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            Tentang Kami
                        </a></li>
                        <li><a href="{{ route('public.programs.index') }}" class="text-green-200 hover:text-white transition-colors duration-200 flex items-center group text-sm">
                            <svg class="w-4 h-4 mr-2 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            Program Pendidikan
                        </a></li>
                        <li><a href="{{ route('public.news.index') }}" class="text-green-200 hover:text-white transition-colors duration-200 flex items-center group text-sm">
                            <svg class="w-4 h-4 mr-2 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            Berita
                        </a></li>
                        <li><a href="{{ route('public.gallery') }}" class="text-green-200 hover:text-white transition-colors duration-200 flex items-center group text-sm">
                            <svg class="w-4 h-4 mr-2 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            Galeri
                        </a></li>
                        <li><a href="{{ route('public.contact') }}" class="text-green-200 hover:text-white transition-colors duration-200 flex items-center group text-sm">
                            <svg class="w-4 h-4 mr-2 group-hover:translate-x-1 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            Kontak
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <div>
                                <p class="text-green-200 text-xs">Email</p>
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <p class="text-green-200 text-xs">Telepon</p>
                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <p class="text-green-200 text-xs">Alamat</p>
            ...
            <div class="border-t border-green-700 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
                <p class="text-green-200 text-sm text-center sm:text-left">
